...
describe('channel administration template', () => {
  ...
  test('renders strict network-era choices, visual dayparts, and editable owned-title checks', () => {
    ...
    expect(networkPanel).toContain('All known suggestions for this network are listed below')
    expect(networkPanel).toContain('resolve its approval and metadata in the TV library')
