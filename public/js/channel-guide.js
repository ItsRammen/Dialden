(function () {
  ...
  function render() {
    ...
    dialog.querySelector('[data-help]').textContent = state.mode === 'admin' ? 'Full broadcast timeline, including station assets. Times follow the channel timezone.' : 'Programs only. Station assets still play between programs; start times are unchanged.';
